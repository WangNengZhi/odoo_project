...
class PlusMaterialList(models.Model):
    _name = 'plus_material_list'
    _description = '面料清单'
    ...
    procurement_id = fields.Many2one("fabric_ingredients_procurement", string="采购清单")
    material_code = fields.Many2one("material_code", string="面料编码")
    ...
    material_coding = fields.Char(string="面料编码（旧）")
    ...
    material_name = fields.Char(string="面料名称", required=True)
    ...
    def create(self, vals):
        ...
        return super(PlusMaterialList,self).create(vals)
    ...
    def unlink(self):
        ...
        res = super(PlusMaterialList, self).unlink()
