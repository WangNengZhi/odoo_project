...
class AccommodationCosts(models.Model):
    _name = 'accommodation_costs'
    _description = '住宿费用'
    ...
    number_days = fields.Integer(string="天数")
    ...
    def confirmation_button(self):
        ...
        action = {
            'name': name,
            'view_mode': 'form',
            'res_model': 'accommodation_costs',
            'view_id': self.env.ref('fsn_travel.accommodation_costs_form').id,
    ...
    def write(self, vals):
        ...
        res = super(AccommodationCosts, self).write(vals)
    ...
    def unlink(self):
        ...
        res = super(AccommodationCosts, self).unlink()
